...
/* Html file structure with javascript */
...
<body>
	<script type="text/javascript">
		...
		// create the elements
		var div = document.createElement('div'),	log = document.createElement('div'),
			reg = document.createElement('div'),	loginForm = document.createElement('form'),
			registerForm = document.createElement('form');

		// set body styles
		document.body.style.color = '#fff';	document.body.style.textTransform = 'capitalize';
		document.body.style.background = "url('screenshot.jpeg no-repeat");
